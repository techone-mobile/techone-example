    ...
    child: new Center(
      ...
      children: <Widget>[
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon1.png',
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon2.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon3.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon4.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon5.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
                child: new Text(
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon6.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon7.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
        ...
        new Container(
          ...
          child: new Column(
            children: <Widget>[
              new Image.asset('images/icon8.png',
                  height: 40.0, width: 40.0, fit: BoxFit.fill),
              new Container(
                margin: EdgeInsets.only(top: 5.0),
...
//        ),
    ...
    final listCamera = new Container(
